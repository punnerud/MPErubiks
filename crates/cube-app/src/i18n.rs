...
fn no(k: TextKey) -> &'static str {
    ...
    match k {
        ...
        Scramble => "Bland",
        Practice => "Øv",
        SettingsTitle => "Løsningsvalg",
        HintModeFull => "Full guide",
        HintModePractice => "Øve-stopp",
        HintModeOff => "Av",
        MaxExtraMoves => "Maks ekstra trekk",
        IDidIt => "Jeg klarte det!",
        NeededHelp => "Trengte en titt",
        PracticeYouKnow => "Denne kan du!",
        SettingsNoTrained => "Merk algoritmer med stjerne i Train først",
        TapSelectTitle => "Trykk velger",
        TapSelectSide => "Siden",
        TapSelectCell => "Cellen",
        Reset => "Nullstill",
        Undo => "Angre",
